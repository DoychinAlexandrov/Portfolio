        ...
        <div className="w-full">
            ...
            <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
                <div className="col-span-4">
                    ...
                    <br />
                    <p>
                        This app was built using React JS,Tailwind CSS & Stipe
                        and is hosted on Vercel.The app is accepting checkout
                        payments with stripe creating a fully featured shopping
                        cart to checkout multiple items.
                    </p>
                    <a
                        href="https://github.com/DoychinAlexandrov/tech-store"
                        target="_blank"
                        rel="noreferrer"
                    >
                    ...
                    <a
                        href="https://tech-store-chi.vercel.app/"
                        target="_blank"
                        rel="noreferrer"
                    >
